...
import { LogOut, User, Clock, FileText, CheckCircle, XCircle, UserX, Calendar } from 'lucide-react';
  ...
  const handleStatusChange = (appointmentId: number, newStatus: string) => {
    ...
    toast.success(
      language === 'en' 
        ...
        : `Uko gahunda imeze yahinduwe kuri ${newStatus}`
    );
  };
        ...
        <DialogContent className="max-w-md">
          ...
          {selectedPatient && (
            <div className="space-y-4">
              ...
              <Button className="w-full bg-teal-600 hover:bg-teal-700" onClick={handleSaveNotes}>
